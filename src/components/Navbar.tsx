...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-4 z-50 px-4 md:px-6">
      <nav className="w-[20%] mx-auto h-20 px-6 md:px-8 bg-background/80 backdrop-blur-md border border-border/60 rounded-3xl shadow-nav flex items-center justify-between">
